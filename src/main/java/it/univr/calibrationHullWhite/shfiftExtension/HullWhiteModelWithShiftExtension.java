package it.univr.calibrationHullWhite.shfiftExtension;
 ...
 * @version 1.2
 */
public class HullWhiteModelWithShiftExtension extends AbstractProcessModel implements LIBORModel, ShortRateModel{
	...
	//Create a HullWhiteModelWithShiftExtension 
	
	public static HullWhiteModelWithShiftExtension of(
			final RandomVariableFactory		randomVariableFactory,
			final TimeDiscretization			liborPeriodDiscretization,
			final AnalyticModel				analyticModel,
			final ForwardCurve				forwardRateCurve,
		...
		final HullWhiteModelWithShiftExtension model = new HullWhiteModelWithShiftExtension(randomVariableFactory, liborPeriodDiscretization, analyticModel, forwardRateCurve, discountCurve, volatilityModel, properties);
		...
		if(calibrationProducts != null && calibrationProducts.length > 0) {
			...
			final HullWhiteModelWithShiftExtension modelCalibrated = model.getCloneWithModifiedVolatilityModel(volatilityModelCalibrated);
	...
	@Override
	public HullWhiteModelWithShiftExtension getCloneWithModifiedVolatilityModel(ShortRateVolatilityModel volatilityModel) {
		// TODO Auto-generated method stub
		return new HullWhiteModelWithShiftExtension(randomVariableFactory, liborPeriodDiscretization, analyticModel, forwardRateCurve, discountCurve, volatilityModel, properties);
	}
	@Override
